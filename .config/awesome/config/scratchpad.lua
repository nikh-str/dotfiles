...
awesome.connect_signal("scratch::term_scratch", function() term_scratch:toggle() end)
...
awesome.connect_signal("scratch::ranger_scratch", function() ranger_scratch:toggle() end)
...
awesome.connect_signal("scratch::music_scratch", function() music_scratch:toggle() end)
...
awesome.connect_signal("scratch::calendar_scratch", function() calendar_scratch:toggle() end)
