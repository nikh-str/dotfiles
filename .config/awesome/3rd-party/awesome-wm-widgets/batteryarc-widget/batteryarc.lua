...
local WIDGET_DIR = HOME .. '/.config/awesome/3rd-party/awesome-wm-widgets/batteryarc-widget'
...
local function worker(user_args)
    ...
    local font = args.font or 'Hack Nerd Font Bold 6'
    ...
    local main_color = args.main_color or '#68D794'
    local bg_color = args.bg_color or '#463B3B11'
