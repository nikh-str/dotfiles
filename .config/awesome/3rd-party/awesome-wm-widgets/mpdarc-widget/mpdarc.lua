...
local PATH_TO_ICONS = "/usr/share/icons/Papirus/24x24"
local PAUSE_ICON_NAME = PATH_TO_ICONS .. "/actions/player_pause.svg"
local PLAY_ICON_NAME = PATH_TO_ICONS .. "/actions/player_play.svg"
local STOP_ICON_NAME = PATH_TO_ICONS .. "/actions/player_stop.svg"
