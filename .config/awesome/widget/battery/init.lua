-- from here: https://github.com/AllJavi/dotfiles/tree/master/.config/awesome/widget
...
local return_button = function()
	...
	local get_battery_info = function()
		awful.spawn.easy_async_with_shell("upower -i $(upower -e | grep BAT) | grep state", function(stdout)
